<?php if(!defined('Z_PROTECTED')) exit; ?>
		<div id="contact-menu" class="contact-menu" data-id="0">
			<ul>
				...
				<li><a id="menu-cmd-show" href="#" onclick="f_show2(event); return false;"><?php eh($lang["menuContactShow"]) ?></a></li>
				<li><a id="menu-cmd-hide" href="#" onclick="f_hide2(event); return false;"><?php eh($lang["menuContactHide"]) ?></a></li>
